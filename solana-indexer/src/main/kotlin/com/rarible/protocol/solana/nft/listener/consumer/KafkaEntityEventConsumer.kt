...
class KafkaEntityEventConsumer(
    ...
    private fun consumer(group: SubscriberGroup, listener: EntityEventListener): ConsumerBatchWorker<*> {
        val kafkaConsumer: RaribleKafkaConsumer<LogRecordEvent<SolanaLogRecord>> = RaribleKafkaConsumer(
        ...
        ) as RaribleKafkaConsumer<LogRecordEvent<SolanaLogRecord>>
    ...
    ) : ConsumerBatchEventHandler<LogRecordEvent<SolanaLogRecord>> {
        override suspend fun handle(event: List<LogRecordEvent<SolanaLogRecord>>) {
