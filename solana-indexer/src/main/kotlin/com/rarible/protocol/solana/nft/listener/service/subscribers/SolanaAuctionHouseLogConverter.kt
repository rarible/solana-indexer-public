...
object SolanaAuctionHouseLogConverter {
    ...
    fun convertBuy(
        ...
        instruction: Buy,
        dateSeconds: Long
    ): SolanaAuctionHouseOrderRecord.BuyRecord = SolanaAuctionHouseOrderRecord.BuyRecord(
    ...
    fun convertSell(
        ...
        instruction: Sell,
        dateSeconds: Long
    ): SolanaAuctionHouseOrderRecord.SellRecord = SolanaAuctionHouseOrderRecord.SellRecord(
        maker = log.instruction.accounts[0],
    ...
    fun convertCancel(
        ...
        instruction: Cancel,
        dateSeconds: Long
    ): SolanaAuctionHouseOrderRecord.CancelRecord = SolanaAuctionHouseOrderRecord.CancelRecord(
        maker = log.instruction.accounts[0],
