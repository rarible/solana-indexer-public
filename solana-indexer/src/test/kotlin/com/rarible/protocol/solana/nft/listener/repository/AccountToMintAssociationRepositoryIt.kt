...
class AccountToMintAssociationRepositoryIt : AbstractBlockScannerTest() {
    ...
    fun `save - new records`() = runBlocking<Unit> {
        val association1 = AccountToMintAssociation(randomAccount(), randomMint())
        val association2 = AccountToMintAssociation(randomAccount(), randomMint())
    ...
    fun `save - duplicate records`() = runBlocking<Unit> {
        val association1 = AccountToMintAssociation(randomAccount(), randomMint())
        val association2 = AccountToMintAssociation(randomAccount(), randomMint())
        val association3 = AccountToMintAssociation(randomAccount(), randomMint())
